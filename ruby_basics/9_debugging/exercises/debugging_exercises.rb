...
def isogram?(string)
  ...
  string_array = string.downcase.chars # 'split' is better for 'text' (or split(" ")), while 'chars' better for 'words'
...
# First, include require 'pry-byebug' at the top of this page (binding.pry !!!!)
