...
#this is an alternative solution using a hash and Symbol#to_sym and Hash#fetch seems a bit more elegant
def pet_pun(animal)
    puns = {
        cat: "Cats are purr-fect!",
        dog: "Dogs are paw-some!"
    }
    puts puns.fetch(animal.to_sym, "I think #{animal}s have pet-tential!")
end
